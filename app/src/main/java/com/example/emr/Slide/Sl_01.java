...
public class Sl_01 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_sl02);
...
*/
    ...
    public void abrirCalendario(View view){
        Intent cal = new Intent(Sl_01.this, Sl_02.class);
        startActivity(cal);
    }

    public void voltarMenu(View v){
        Intent intent = new Intent(Sl_01.this, MenuActivity.class);
